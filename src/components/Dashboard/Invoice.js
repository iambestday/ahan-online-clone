          ...
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">کد کالا</th>                  <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">نام محصول/تولیدکننده</th>
                  <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">وزن</th>
                 <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">طول</th>
                 <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">مقدار</th>
                 <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">بارگیری از</th>
       <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">قیمت واحد بدون ارزش افزوده (تومان)</th>
      <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">قیمت واحد باارزش افزوده (تومان)</th>
       <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">قیمت کل با ارزش افزوده (تومان)</th>
       <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500">ویرایش</th>
                </tr>
              </thead>
