...
function FooterLayout() {
  ...
  <div className="px-4 pt-16 pb-8 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
      ...
      <div className="col-span-2">
        ...
        ﺷﻨﺒﻪ تا ﭼﻬﺎرﺷﻨﺒﻪ ۹ اﻟﯽ ۱۸:۰۰ | ﭘﻨﺞ‌ﺷﻨﺒﻪ ۹ اﻟﯽ ۱۳:۳۰
ﮐﺎرﺷﻨﺎﺳﺎن ما از ﺷﻨﺒﻪ ﺗﺎ ۵ ﺷﻨﺒﻪ در ﺳﺎﻋﺎت اداری ﭘﺎﺳﺨﮕﻮی ﺳﻮاﻟﺎت ﺷﻤﺎ ﻣﯽ‌ﺑﺎﺷﻨﺪ.
        </p>
